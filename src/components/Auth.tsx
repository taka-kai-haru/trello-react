...
export const Auth: FC = () => {
    ...
    const signUpEmail = async () => {
        ...
        let url = '';
        if (profilePic) {
            await storage.ref(`avatars/${authUser.user?.uid}/image.jpg`).put(profilePic);
            url = await storage.ref(`avatars/${authUser.user?.uid}/image.jpg`).getDownloadURL();
        }
        // ユーザー情報を更新
        ...
        <ThemeProvider theme={defaultTheme}>
            <Grid container component="main" sx={{ height: '100vh' }}>
                ...
                <Grid
                    ...
                    md={7}
                    sx={{
                        backgroundImage: 'url(https://plus.unsplash.com/premium_photo-1669863282929-d738752329a7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=688&q=80)',
                    ...
                    >
                        ...
                        <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 1 }}>
                            ...
                            <Grid container>
                                <Grid item xs>
                                    <span css={loginReset}
                                          onClick={() => setOpnModal(true)}
                                    >
                                        Forgot password?</span>
                                </Grid>
                                <Grid item>
                                    <span css={loginToggleMode} onClick={() => setIsLogin(!isLogin)}>
