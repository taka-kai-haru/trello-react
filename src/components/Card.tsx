...
export const Card: FC<Props> = (props) => {
  const { card } = props;
  // const [limitDateColor, setLimitDateColor] = useState<ChipColor>("success");
  ...
  useEffect(() => {
    if (card.limitDate !== "") {
      ...
      if (card.progress === 100) {
        // 緑
        // limitDateBackgroundStyle(limitDateColors.success.backgroundColor);
        // limitDateBorderStyle(limitDateColors.success.borderColor);
        ...
        // 赤
        // limitDateBackgroundStyle(limitDateColors.error.backgroundColor);
        // limitDateBorderStyle(limitDateColors.error.borderColor);
        ...
        // 黄
        // limitDateBackgroundStyle(limitDateColors.warning.backgroundColor);
        // limitDateBorderStyle(limitDateColors.warning.borderColor);
        ...
        // 青
        // limitDateBackgroundStyle(limitDateColors.primary.backgroundColor);
        // limitDateBorderStyle(limitDateColors.primary.borderColor);
